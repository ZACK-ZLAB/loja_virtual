...
public class ControleExcecoes {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		try {
			serviceSendEmail.sendEmail("zacarias88464.js@gmail.com", "Erro na loja virtual",
	...
	public ResponseEntity<Object> handleBadCredentials(BadCredentialsException bde) {
		return errorConverter.criarJson(ErroDaApi.CREDENCIAIS_INVALIDAS, "Login e/ou senha inválidos");
	}

	@ExceptionHandler(CredentialsExpiredException.class)
	public ResponseEntity<Object> handleCredentialsExpired(CredentialsExpiredException eje) {
		return errorConverter.criarJson(ErroDaApi.TOKEN_EXPIRADO, "Token fora da validade (expirado)");
	}
	...
	public Map<String, Object> handleConstraintViolation(ConstraintViolationException cve) {
		...
		cve.getConstraintViolations().forEach((error) -> {
			...
			String mensagemCompleta = "\"O atributo '" + atributo + "' apresentou o seguinte erro: '" + errorMessage
					+ "'\"";
			String plainJsonError = "{ codigo:" + ErroDaApi.CONDICAO_VIOLADA.getCodigo() + ", mensagem: "
					+ mensagemCompleta + " }";
	...
	public ResponseEntity<Object> handleInvalidDataAccessResourceUsageException(
			InvalidDataAccessResourceUsageException ie) {
