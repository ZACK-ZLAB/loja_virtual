...
import br.com.zlab.loja_virtual.dto.ConsultaFreteDTO;
import br.com.zlab.loja_virtual.dto.EmpresaTransporteDTO;
import br.com.zlab.loja_virtual.dto.EnvioEtiquetaDTO;
import br.com.zlab.loja_virtual.dto.ItemVendaDTO;
import br.com.zlab.loja_virtual.dto.ObjetoPostCarneJuno;
import br.com.zlab.loja_virtual.dto.ProductsEnvioEtiquetaDTO;
import br.com.zlab.loja_virtual.dto.TagsEnvioDto;
import br.com.zlab.loja_virtual.dto.VendaCompraLojaVirtualDTO;
import br.com.zlab.loja_virtual.dto.VolumesEnvioEtiquetaDTO;
...
import br.com.zlab.loja_virtual.model.ItemVendaLoja;
import br.com.zlab.loja_virtual.model.PessoaFisica;
import br.com.zlab.loja_virtual.model.StatusRastreio;
import br.com.zlab.loja_virtual.model.VendaCompraLojaVirtual;
import br.com.zlab.loja_virtual.repository.ContaReceberRepository;
...
import br.com.zlab.loja_virtual.repository.StatusRastreioRepository;
...
public class Vd_Cp_loja_Virt_Controller {
	...
	public ResponseEntity<VendaCompraLojaVirtualDTO> salvarVendaLoja(
			@RequestBody @Valid VendaCompraLojaVirtual vendaCompraLojaVirtual) throws LojaVirtualException, UnsupportedEncodingException, MessagingException {
		...
		/*assunto, msg, destino*/
		serviceSendEmail.sendEmail(pessoaFisica.getEmail(),"Compra Realizada",msgemail.toString());
		...
		serviceSendEmail.sendEmail(vendaCompraLojaVirtual.getEmpresa().getEmail(), "Venda Realizada" ,msgemail.toString() );
	...
	public ResponseEntity<String> cancelaEtiqueta(@PathVariable String idEtiqueta, @PathVariable String reason_id, @PathVariable String descricao) throws IOException{
		...
		okhttp3.Request request = new Request.Builder()
				  ...
				  .addHeader("User-Agent", "zlabtestes@gmail.com")
				  .build();
	...
	public ResponseEntity<String> imprimeCompraEtiquetaFrete(@PathVariable Long idVenda) throws LojaVirtualException, IOException {
		...
		envioEtiquetaDTO.getFrom().setDistrict(compraLojaVirtual.getEmpresa().getEnderecos().get(0).getEstado());/*isso é bairro jdev é burro*/
		...
		envioEtiquetaDTO.getTo().setDistrict(compraLojaVirtual.getPessoa().enderecoEntrega().getEstado());/*bairro*/
		...
		/*realiza o rastreio*/
		        ...
		        okhttp3.Request requestR = new Request.Builder()
				  ...
				  .addHeader("Content-Type", "application/json")
				  .addHeader("Authorization", "Bearer " +  ApiTokenIntegracao.TOKEN_MELHOR_ENVIO_SAND_BOX)
				  .addHeader("User-Agent", "zlabtestes@gmail.com").build();
