...
@Entity
@Table(name = "marca_usuario")
@SequenceGenerator(name = "seq_marca_usuario", sequenceName = "seq_marca_usuario", allocationSize = 1, initialValue = 1)
public class Usuario implements UserDetails{
	...
	/*Autoridades = São os acessos , ROLE_ADMIN, ROLE_SECRETARIO, ROLE_FINACEIRO*/
	@Override
