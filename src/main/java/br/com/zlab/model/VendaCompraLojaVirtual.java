...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "forma_pagamente_id", nullable = false, 
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "forma_pagamente_fk"))
	...
	@ManyToOne
	@JoinColumn(name = "cumpo_desc_id", nullable = false, 
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "cumpo_desc_fk"))
